    ...
    <>
      <div className="dashboard_cost">
        <div className="crm_card p-3 d-flex justify-content-between align-items-center">
          <span className="color_gray font-xl fw-normal">
            Cost Per Purchase
          </span>{" "}
        ...
        <p className="ps-3 mb-0 pt-2 mb-5">
        ...
        <div className="crm_card p-3 d-flex justify-content-between align-items-center">
          <span className="color_gray font-xl fw-normal">Cost Per Lead</span>{" "}
        </div>
        <p className="ps-3 mb-0 pt-2 mb-5">
          <span className="color_dark_black font-xxl ff_thicccboi_medium ">
            $30.5
        ...
        <div className="crm_card p-3 d-flex justify-content-between align-items-center">
          <span className="color_gray font-xl fw-normal">Cost Per Click</span>{" "}
          <span className="color_green font-sm ff_plex_mono fw_500">
            +15.5%
          </span>
        </div>
